...
EXIT_STATUS=0
for driver in values_tests parse_expression_tests call_function_tests aggregate_meta_test aggregate_exec_test transpose_test stats_test statistics_tests commands_tests; do
   echo ""
