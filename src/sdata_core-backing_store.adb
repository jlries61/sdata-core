      ...
      begin
         ...
         for R in 1 .. Memory_Rows loop
            ...
            for C in 1 .. Natural (Col_Names.Length) loop
               ...
               begin
                  case Val.Kind is
                     --  Bind via the 64-bit path (Ada_Sqlite3.Double64) rather
                     ...
                     when Val_Numeric =>
                        Ada_Sqlite3.Double64.Bind_Double64
                  ...
                  begin
                     if Stmt.Column_Is_Null (I) then
                        ...
                        Val := (Kind => Val_Numeric,
                                Num_Val => Real
                                  (Ada_Sqlite3.Double64.Column_Double64 (Stmt, I)));
